// This is an empty Ballerina class autogenerated to represent the `au.com.dius.pact.consumer.dsl.PactDslRequestWithPath` Java class.
//
...
//               (<class-name>...)
//
// E.g. $ bal bindgen au.com.dius.pact.consumer.dsl.PactDslRequestWithPath
