// This is an empty Ballerina class autogenerated to represent the `au.com.dius.pact.consumer.ConsumerPactBuilder$Companion` Java class.
//
...
//               (<class-name>...)
//
// E.g. $ bal bindgen au.com.dius.pact.consumer.ConsumerPactBuilder\$Companion
...
distinct class Companion {
    ...
    *java:JObject;
    ...
    # The `handle` field that stores the reference to the `au.com.dius.pact.consumer.ConsumerPactBuilder$Companion` object.
    public handle jObj;
