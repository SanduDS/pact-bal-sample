...
public distinct class HttpPartBuilder {
    ...
    *Object;
    ...
    public function body(BodyBuilder arg0) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_body(self.jObj, arg0.jObj);
    ...
    public function body2(DslPart arg0) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_body2(self.jObj, arg0.jObj);
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function body3(string arg0) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_body3(self.jObj, java:fromString(arg0));
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function body4(string arg0, string arg1) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_body4(self.jObj, java:fromString(arg0), java:fromString(arg1));
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function bodyMatchingContentType(string arg0, byte[] arg1) returns HttpPartBuilder|error {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_bodyMatchingContentType(self.jObj, java:fromString(arg0), check jarrays:toHandle(arg1, "byte"));
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function bodyMatchingContentType2(string arg0, string arg1) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_bodyMatchingContentType2(self.jObj, java:fromString(arg0), java:fromString(arg1));
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function 'equals(Object arg0) returns boolean {
        return au_com_dius_pact_consumer_dsl_HttpPartBuilder_equals(self.jObj, arg0.jObj);
    }
    ...
    public function header(string arg0, Object arg1) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_header(self.jObj, java:fromString(arg0), arg1.jObj);
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function headers(Map arg0) returns HttpPartBuilder {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_headers(self.jObj, arg0.jObj);
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
    ...
    public function headers3(string arg0, string arg1, string[] arg2) returns HttpPartBuilder|error {
        handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_headers3(self.jObj, java:fromString(arg0), java:fromString(arg1), check jarrays:toHandle(arg2, "java.lang.String"));
        HttpPartBuilder newObj = new (externalObj);
        return newObj;
    }
...
public function newHttpPartBuilder1(IHttpPart arg0) returns HttpPartBuilder {
    handle externalObj = au_com_dius_pact_consumer_dsl_HttpPartBuilder_newHttpPartBuilder1(arg0.jObj);
    HttpPartBuilder newObj = new (externalObj);
    return newObj;
}
