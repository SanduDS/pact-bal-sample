// This is an empty Ballerina class autogenerated to represent the `au.com.dius.pact.consumer.PactTestExecutionContext` Java class.
//
...
//               (<class-name>...)
//
// E.g. $ bal bindgen au.com.dius.pact.consumer.PactTestExecutionContext
